...
/**
 * Checks and analyzers report measurements, violations and other findings in CssSourceCode.
 * 
 * @author Kevin Weisser
 */
public class CssSourceCode {
	...
	public CssSourceCode(Resource<?> resource) {
